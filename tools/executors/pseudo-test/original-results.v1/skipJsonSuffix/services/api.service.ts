...
export class ApiService extends BaseService {
     ...
     */
    fooGet$Response(params?: {}): Observable<StrictHttpResponse<string>> {
     ...
     * This method doesn't expect any request body.
     */
    fooGet(params?: {}): Observable<string> {
        return this.fooGet$Response(params).pipe(map((r: StrictHttpResponse<string>) => r.body as string));
    }
     ...
     * This method doesn't expect any request body.
     */
    fooGet$Plain$Response(params?: {}): Observable<StrictHttpResponse<any>> {
        const rb = new RequestBuilder(this.rootUrl, ApiService.FooGetPath, 'get');
        if (params) {
        }
     ...
     * This method doesn't expect any request body.
     */
    fooGet$Plain(params?: {}): Observable<any> {
        return this.fooGet$Plain$Response(params).pipe(map((r: StrictHttpResponse<any>) => r.body as any));
    }
     ...
     * This method doesn't expect any request body.
     */
    barGet$Response(params?: {}): Observable<StrictHttpResponse<any>> {
     ...
     * This method doesn't expect any request body.
     */
    barGet(params?: {}): Observable<any> {
        return this.barGet$Response(params).pipe(map((r: StrictHttpResponse<any>) => r.body as any));
    }
}
