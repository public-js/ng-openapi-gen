...
export class ApiService extends BaseService {
     ...
     */
    getPath1$Response(params?: {}): Observable<StrictHttpResponse<string>> {
     ...
     * This method doesn't expect any request body.
     */
    getPath1(params?: {}): Observable<string> {
        return this.getPath1$Response(params).pipe(map((r: StrictHttpResponse<string>) => r.body as string));
    }
     ...
     * This method doesn't expect any request body.
     */
    getPath2$Response(params?: {}): Observable<StrictHttpResponse<number>> {
     ...
     * This method doesn't expect any request body.
     */
    getPath2(params?: {}): Observable<number> {
        return this.getPath2$Response(params).pipe(map((r: StrictHttpResponse<number>) => r.body as number));
    }
}
