...
export class Tag1Service extends BaseService {
    ...
    path1Get$Json(params: {
        ...
        return this.path1Get$Json$Response(params).pipe(map((r: StrictHttpResponse<RefObject>) => r.body as RefObject));
    }
    ...
    path1Get$Image(params: {
        ...
        return this.path1Get$Image$Response(params).pipe(map((r: StrictHttpResponse<Blob>) => r.body as Blob));
    }
    ...
    path2Get(params: {
        ...
        return this.path2Get$Response(params).pipe(map((r: StrictHttpResponse<void>) => r.body as void));
    }
}
