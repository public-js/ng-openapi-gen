...
export class Tag2Service extends BaseService {
    ...
    path1Post$Json(params: {
        ...
        return this.path1Post$Json$Response(params).pipe(map((r: StrictHttpResponse<void>) => r.body as void));
    }
    ...
    path1Post$Plain(params: {
        ...
        return this.path1Post$Plain$Response(params).pipe(map((r: StrictHttpResponse<void>) => r.body as void));
    }
}
