...
export class TagTag2Tag3Tag4Tag5Service extends BaseService {
     ...
     */
    path5Get$Response(params?: {}): Observable<StrictHttpResponse<{}>> {
     ...
     * This method doesn't expect any request body.
     */
    path5Get(params?: {}): Observable<{}> {
        return this.path5Get$Response(params).pipe(map((r: StrictHttpResponse<{}>) => r.body as {}));
    }
}
