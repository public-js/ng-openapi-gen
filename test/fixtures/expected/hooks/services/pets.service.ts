...
/** Pets operations observed by the hook fixture. */
@Injectable()
export class PetsService {
  /** Path part for operation `listPets` */
  private static readonly ListPetsPath: string = '/pets';
  /** Path part for operation `createPets` */
  private static readonly CreatePetsPath: string = '/pets';
  /** Path part for operation `showPetById` */
  private static readonly ShowPetByIdPath: string = '/pets/{petId}';

  constructor(@Inject(API_ROOT_URL_TOKEN) private rootUrl: string, @Inject(HttpClient) private http: HttpClient) {
  }
  ...
  public listPets$Response(params?: {
       ...
       */
      limit?: number;
    }, context?: HttpContext): Observable<StrictHttpResponse<Pets>> {
  ...
  public listPets(params?: {
       ...
       */
      limit?: number;
    }, context?: HttpContext): Observable<Pets> {
